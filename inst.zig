pub fn instToBytes(inst: Inst) []const u8 {
  return switch (inst) {
    ...
    .@"i8x16.relaxed_swizzle" => .{ 0xfd, , 0x1 },
    .@"i32x4.relaxed_trunc_f32x4_s" => .{ 0xfd, 0x1, 0x1 },
    .@"i32x4.relaxed_trunc_f32x4_u" => .{ 0xfd, 0x2, 0x1 },
    .@"i32x4.relaxed_trunc_f64x2_s_zero" => .{ 0xfd, 0x3, 0x1 },
    .@"i32x4.relaxed_trunc_f64x2_u_zero" => .{ 0xfd, 0x4, 0x1 },
    .@"f32x4.relaxed_madd" => .{ 0xfd, 0x5, 0x1 },
    .@"f32x4.relaxed_nmadd" => .{ 0xfd, 0x6, 0x1 },
    .@"f64x2.relaxed_madd" => .{ 0xfd, 0x7, 0x1 },
    .@"f64x2.relaxed_nmadd" => .{ 0xfd, 0x8, 0x1 },
    .@"i8x16.relaxed_laneselect" => .{ 0xfd, 0x9, 0x1 },
    .@"i16x8.relaxed_laneselect" => .{ 0xfd, 0xa, 0x1 },
    .@"i32x4.relaxed_laneselect" => .{ 0xfd, 0xb, 0x1 },
    .@"i64x2.relaxed_laneselect" => .{ 0xfd, 0xc, 0x1 },
    .@"f32x4.relaxed_min" => .{ 0xfd, 0xd, 0x1 },
    .@"f32x4.relaxed_max" => .{ 0xfd, 0xe, 0x1 },
    .@"f64x2.relaxed_min" => .{ 0xfd, 0xf, 0x1 },
    .@"f64x2.relaxed_max" => .{ 0xfd, 0x10, 0x1 },
    .@"i16x8.relaxed_q15mulr_s" => .{ 0xfd, 0x11, 0x1 },
    .@"i16x8.relaxed_dot_i8x16_i7x16_s" => .{ 0xfd, 0x12, 0x1 },
    .@"i32x4.relaxed_dot_i8x16_i7x16_add_s" => .{ 0xfd, 0x13, 0x1 },
